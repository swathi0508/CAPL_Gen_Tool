...
from PyQt6.QtWidgets import (QApplication, QMainWindow, QWidget, QVBoxLayout, 
                             ...
                             QComboBox, QTextEdit, QFileDialog, QCheckBox)
...
class CaplGenGUI(QMainWindow):
    ...
    def _build_log_section(self):
        ...
        self.cb_verbose = QCheckBox("Enable Verbose Log / Dev Mode"); layout.addWidget(self.cb_verbose)
    ...
    def _on_pre_process_complete(self):
        ...
        self.write_log("✅ Pre-Processing is complete.")
    ...
    def run_preprocess(self):
        ...
        self.write_log("--- Initializing Processing Pipeline ---")
        ...
        def task():
            try:
                self.signals.log_signal.emit("⚙️ Parsing ARXML and Network Databases...")
                self.pipeline.build_databases(arxml)
                self.signals.log_signal.emit("⚙️ Mapping Requirements to memory...")
    ...
    def run_generation(self):
        ...
        try:
            self.pipeline.run_generation("GeneratedTestScripts", category, test_type)
            self.write_log("✅ CAPL Scripts Generated Successfully.")
