...
class CaplCanToCanBasicFuncAndVarsGenerator:
    def __init__(self, template_dir):
        ...
        self.j2_columns = [
            'CAN_PORT', 'CAN_DB_SIGNAL_NAME', 'CAN2_DB_SIGNAL_NAME',
            'CAN_ENUM', 'CAN2_ENUM', 'CAN_TO_CAN_MAPPING', 'BASIC_FUNCTION_NAME',
            'CAN_OFFSET', 'CAN_RESOLUTION', 'CAN2_OFFSET', 'CAN2_RESOLUTION', 'IS_ENUM',
